...
const Register = () => {
    ...
    return (
        <div>
            ...
            <div className="absolute inset-0 bg-cover bg-center mb-28 mt-2 " style={{ backgroundImage: `url(${bgImage})` }}></div>
            </div>
  ...
  <input className='w-full border-b-2 border-gray-100 focus:border-purple-600 focus:outline-none p-0 mt-1 mb-3' placeholder='******' type='password' name='pwd' value={formData.pwd} onChange={handleChange} /><br />
  
  <label className='text-gray-600 text-sm font-bold' htmlFor='dept'>Department</label>
  <select className='w-full border-b-2 border-gray-100 focus:border-purple-600 focus:outline-none p-0 mt-1 mb-3' name='dept' value={formData.dept} onChange={handleChange}>
    <option value=""></option>
  ...
  <input className='w-full border-b-2 border-gray-100 focus:border-purple-600 focus:outline-none p-0 mt-1 mb-3' placeholder='2022/12414' type='text' name='regno' value={formData.regno} onChange={handleChange} /><br />
